...
export const PAYMENT_METHODS: PaymentMethodConfig[] = [
    {
        ...
        description: "Use your PayPal account for point checkout and withdrawal requests.",
    ...
    },
    {
        ...
        description: "Connect your BitPay wallet and use it across checkout and withdrawals.",
    ...
    },
    {
        ...
        description: "Continue with Stripe checkout and manage payouts from your Stripe account.",
...
export const PAYMENT_METHOD_MAP = PAYMENT_METHODS.reduce<Record<PaymentMethodId, PaymentMethodConfig>>(
    (accumulator, method) => {
