...
export default function CoinReceivedToast({
    ...
    return (
        <div className="w-full overflow-hidden rounded-2xl border border-white/10 bg-black/95 backdrop-blur-xl shadow-2xl">
            <div className="flex gap-4 p-4">
                <div className=" flex items-center justify-center h-10 w-10 shrink-0 overflow-hidden rounded-3xl ">
                    <BrandMark width={100} height={100} />
                </div>
                <div className="flex-1">
                    <div className="flex items-start justify-between">
                        <h3 className="text-[.7rem] md:text-[.9rem] font-bold text-white">
                            Model Boss Offers
                        </h3>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[.67rem] md:text-[.9rem] text-gray-200">
                            Money Received
                        </span>
                    </div>

                    <p className="text-[.67rem] md:text-[0.9rem] text-white">
