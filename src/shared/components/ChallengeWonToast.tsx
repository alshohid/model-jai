...
interface IChallengeWonToastProps {
    amount: number;
}

export default function ChallengeWonToast({
    amount,
}: IChallengeWonToastProps) {
    return (
        <div className="w-full overflow-hidden rounded-2xl border border-yellow-500/20 bg-black/95 backdrop-blur-xl shadow-2xl">
            ...
            {/* Bottom Accent */}
            <div className="h-1 w-40 rounded-r-full bg-gradient-to-r from-yellow-400 to-orange-500" />
        </div>
    );
}