...
export default function PromotionalPriceOffer() {
    return (
        <div className="relative rounded-[12px] border-2 border-[#ff49ff] bg-black/72 px-4 py-3 text-left">
            <div className="absolute -top-5 left-5 text-[13px] font-black text-[#fff200] [text-shadow:0_1px_0_#000,0_0_8px_rgba(255,242,0,0.75)]">
