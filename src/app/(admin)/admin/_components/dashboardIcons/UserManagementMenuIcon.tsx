...
const UserManagementMenuIcon = ({ className }: { className?: string }) => {
    return (
        <svg
        ...
        >
            <path
                d="M10.8333 9.16536C10.8333 7.32441 9.34088 5.83203 7.49996 5.83203C5.65901 5.83203 4.16663 7.32441 4.16663 9.16536C4.16663 11.0063 5.65901 12.4987 7.49996 12.4987C9.34088 12.4987 10.8333 11.0063 10.8333 9.16536Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
            ...
            />
            <path
                d="M17.5 14.168C17.5 11.4066 15.2614 9.16797 12.5 9.16797"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
